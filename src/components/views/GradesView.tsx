  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-[1600px] mx-auto space-y-8">
      ...
      <section className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl text-[#090d16] font-bold text-xs bg-gradient-to-r from-[#06b6d4] to-[#0891b2] hover:shadow-[0_0_24px_rgba(6,182,212,0.6)] shadow-lg shadow-[#06b6d4]/30 flex items-center gap-2 transition-all cursor-pointer transform hover:-translate-y-0.5"
          >
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div className={`p-5 rounded-2xl backdrop-blur-2xl border shadow-xl flex flex-col justify-between transition-all duration-300 ${
          isDark
        ...
        <div className={`p-5 rounded-2xl backdrop-blur-2xl border shadow-xl flex flex-col justify-between transition-all duration-300 ${
          ...
          <div className={`mt-4 pt-3 border-t space-y-1.5 ${isDark ? 'border-white/5' : 'border-slate-100'}`}>
            <div className={`w-full rounded-full h-1.5 overflow-hidden ${isDark ? 'bg-[#262a34]' : 'bg-slate-100'}`}>
              <div className="bg-gradient-to-r from-[#00a572] to-[#4edea3] h-1.5 rounded-full" style={{ width: '94%' }} />
            </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className={`lg:col-span-2 p-6 rounded-2xl backdrop-blur-2xl border shadow-xl space-y-6 ${
